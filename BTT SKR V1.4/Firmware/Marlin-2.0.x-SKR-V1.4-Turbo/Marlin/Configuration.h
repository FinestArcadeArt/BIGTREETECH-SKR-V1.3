 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 100, 35 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 700, 700, 100, 50 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50, -10, -6.2 }
...
//#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 400
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BRIGHTNESS 170  // Initial brightness (0-255)
  ...
  //#define NEOPIXEL2_SEPARATE
    ...
    #define NEOPIXEL2_BRIGHTNESS 160  // Initial brightness (0-255)
